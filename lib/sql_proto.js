...
var SQLProto = {
  ...
  */
  ...
  queryWhere: function(o, callback) {
    var args, 
        self = this,
  ...
  insertInto: function(o, callback) {
  ...
  deleteById: function(o, callback) {
    var args,
        id = o.id,
        table = o.table || '',
        appendSql = o.appendSql || '';
  ...
  deleteWhere: function(o, callback) {
    var args, 
        self = this,
        condition = o.condition || '',
        params = o.params || [],
  ...
  updateById: function(o, callback) {
    var args,
        id = o.id,
        table = o.table || '',
        values = o.values || {},
  ...
  updateWhere: function(o, callback) {
    var args,query, 
        self = this,
        condition = o.condition || '',
        params = o.params || [],
...
// Freeze modifications of sql proto object
Object.freeze(SQLProto);

module.exports = SQLProto;
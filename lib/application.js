...
// Set validator constructor
Application.prototype.validator = function() {
  return new protos.lib.validator();
}
...
Application.prototype.validate = function(req, fields, onlyCheck) {
  ...
  if (route.validation != null) {
    ...
    for (param in fields) {
      ...
      if (route.validation[param] != null) {
        ...
        if ( regex.test(fields[param]) ) {
          ...
          res.httpMessage(req.isAjax ? 200 : 400, msg);
    ...
    if (counter !== (paramKeys.length - exclude)) {
      ...
      res.httpMessage(req.isAjax ? 200 : 400, 'Missing required fields');
